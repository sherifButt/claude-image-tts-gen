...
const videoInputSchema = {
  ...
  properties: {
    ...
    imagePath: {
      type: "string",
      description:
        "Path to the input frame to animate. Required — grok-imagine-video-1.5 is image-to-video only. Generate one with generate_image first if you don't have a still.",
    },
    referenceImagePaths: {
      type: "array",
      items: { type: "string" },

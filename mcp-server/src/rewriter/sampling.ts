...
const PROVIDER_GUIDANCE: Record<ProviderId, string> = {
  ...
  replicate:
    "grok-imagine-video-1.5 (image-to-video): describe the MOTION — how the subject and camera move, pacing, and any ambient sound. The still frame already sets the scene; focus the prompt on what changes over time.",
};
